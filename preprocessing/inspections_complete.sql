...
DROP TABLE IF EXISTS raw.inspections_complete;

CREATE TABLE raw.inspections_complete (
...
\COPY raw.inspections_complete from '/mnt/data/projects/direccion_trabajo_inspections/preprocessing/inspections_complete.csv' WITH DELIMITER ';' NULL '.' CSV HEADER;
